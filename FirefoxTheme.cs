    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int i = 0; i <= TabPages.Count - 1; i++)
        {
            ...
            if (SelectedIndex == i)
            {
                ...
                using (SolidBrush B = new SolidBrush(Color.FromArgb(190, 99, 249)))
                {
            ...
            if (i == 0)
            {
                G.DrawImage(Resources.search_480px, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
            else if (i == 1)
            {
                G.DrawImage(Resources.find_user_male_480px, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
            else if (i == 2)
            {
                G.DrawImage(Resources.death_insurance_480px, new Rectangle(TabRect.X + 19, TabRect.Y + ((TabRect.Height / 2) - 10), 22, 22));
            }
        }
